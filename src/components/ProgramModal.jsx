...
export default function ProgramModal({ showModal, setShowModal, onSubmit }) {
  ...
  return (
    <dialog
      className="fixed mt-[6%] bg-white rounded-xl z-10 w-[650px] h-[80vh]"
      open={showModal}
    >
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  w-full px-10">
        ...
        <div className="flex flex-col gap-4 my-4">
          <p>
            Når du gemmer et program, skal du give det et navn. Vær opmærksom på
            at navnet skal give mening for dig, så du kan skelne mellem de
            forskellige programmer.
          </p>
          <p>
            Vi anbefaler også, at du giver programmet en beskrivelse, som kan
            hjælpe dig med at huske indholdet af øvelser.
          </p>
        </div>
        <form
        ...
        >
          ...
          <label
            ...
            className="flex items-center font-manjari text-lg font-bold"
          >
